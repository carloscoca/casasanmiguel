...
jQuery.extend(jQuery.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			if (this.settings.validHandler)
				jQuery(this.currentForm).bind("valid-form", this.settings.validHandler);
		},
		...
		form: function() {
			...
			if (!this.valid()) {
				...
				jQuery(this.currentForm).triggerHandler("valid-form", [this]);
			}
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				/*if ( !this.labelContainer.parent().append(label).length )
                //if ( !this.labelContainer.append(label).length )
					this.settings.errorPlacement
						? this.settings.errorPlacement(label, jQuery(element) )
						: $(element).parent().append(label);// label.insertAfter(element);*/
		...
		errorsFor: function(element) {
    		...
    		return this.errors().filter(function() {
				return jQuery(this).attr('for') == name && jQuery(this).attr('generated') == 'true';
			});
		},
	...
	methods: {
		...
		remote: function(value, element, param) {
            ...
            data['extra'] = validator.settings.extra;
